...
- [x] Zadanie 1c: Udokumentować weryfikację domeny organizacji TXT `_gh-SilesianGames-o.www.larpkronikiognia.pl` z kodem `6224e5ae12` — Test: `pytest tests/test_custom_domain.py::test_domain_verification_txt_documented`
